...
// Legacy Card is intentionally static in V2. Clickable surfaces should use
// Pressable/Touchable wrappers or the new v2 SurfaceCard. Keeping layout style
// on this outermost node fixes flex/width bugs caused by the old Animated wrapper.
