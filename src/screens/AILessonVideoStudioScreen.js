...
export default function AILessonVideoStudioScreen({ navigation }) {
    ...
    <Screen scroll contentStyle={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerTextWrap}>
          ...
          <Text style={styles.sub}>Experimental lesson video builder</Text>
        </View>
      </View>
      ...
      <Card style={styles.card}>
        ...
        <Text style={styles.hint}>
          Source: {isVideoLessonApiConfigured() ? 'Online AI endpoint' : 'Offline generator fallback'}
        </Text>
            ...
            {lesson.video?.videoUrl ? (
              <View style={styles.videoLaunchWrap}>
                <Text style={styles.videoMeta}>
                  Video: {lesson.video.generated ? 'AI generated URL' : 'Fallback sample URL'} • {lesson.video.provider}
                </Text>
                <Button
